...
import os
import sys
import crc.image_crc as crc
import digital_signal.image_aes as aes
...
def make_image(
    ...
    if cripted == check_cripted.GCM:
        ...
        payload , iv = aes.aes_cbc_encrypt(fw, key)
        aux = iv + make_hmac_tag(key, payload, hashlib.sha256)
...
def main():
    ...
    try:
        ...
        make_image(args.bin_file, args.image_path, args.version, args.tag, args.is_front, check_cripted[args.check], key,
